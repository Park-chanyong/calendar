...
struct WidgetTimetableEntry: Identifiable, Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, title, weekday, startHour, startMinute, endHour, endMinute, colorName, isImportant
    }
...
struct TimetableWidgetView: View {
    ...
    var body: some View {
        GeometryReader { geo in
            ...
            let pad: CGFloat   = 5
            let axisW: CGFloat = small ? 16 : 22
            let hdrH:  CGFloat = small ? 13 : 17
            let fs:    CGFloat = small ?  6 :  8
