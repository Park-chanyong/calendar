        ...
        NavigationView {
            Form {
                ...
                Section("기본 정보") {
                    ...
                    DatePicker("시작 시간", selection: $draft.startTime, displayedComponents: [.hourAndMinute])
                    DatePicker("종료 시간", selection: $draft.endTime,   displayedComponents: [.hourAndMinute])
                }
