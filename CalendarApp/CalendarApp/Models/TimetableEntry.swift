...
struct TimetableEntry: Identifiable, Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case id, title, weekday, startHour, startMinute, endHour, endMinute, colorName, iconName, location, memo, isImportant
    }

    init(id: UUID = UUID(), title: String, weekday: Int,
         startHour: Int, startMinute: Int, endHour: Int, endMinute: Int,
         colorName: String, iconName: String = "", location: String = "",
         memo: String = "", isImportant: Bool = false) {
        self.id          = id
        self.title       = title
